/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 77af9865fb70605f79eff5e223c442d1)
// Runtime types generated with workerd@1.20260217.0 2025-09-27 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASSETS: Fetcher;
		SURREAL_URL: "https://fanapen-06e6ofnak5v6rcefclqfcb7he4.aws-aps1.surreal.cloud/";
		SURREAL_NAMESPACE: "FanaPen";
		SURREAL_DATABASE: "one";
		SURREAL_USERNAME: "fanapen";
		SURREAL_PASSWORD: "fanapen69";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SURREAL_URL" | "SURREAL_NAMESPACE" | "SURREAL_DATABASE" | "SURREAL_USERNAME" | "SURREAL_PASSWORD">> {}
}
