...
<AuthCard title="FanaPen" subtitle="Sign in to your account">
	<form method="POST" class="mt-8 space-y-6">
		...
		<div>
			<Button type="submit" variant="success" class="w-full">Sign in</Button>
		</div>

		<div class="text-center text-sm">
			<a href="/register" style="color: #c9d1d9;" class="hover:underline">
